...
| Tampered credential | `tampered.json` | DENY / `SIGNATURE_INVALID` | DENY / `SIGNATURE_INVALID` | PASS |
...
| Subject mismatch | `subject-mismatch.json` + correct holder | DENY / `SUBJECT_MISMATCH` | DENY / `SUBJECT_MISMATCH` | PASS |
